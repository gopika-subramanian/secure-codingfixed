...
if(isset($_POST["submit"])) {
 ...
 $fileMimeType = mime_content_type($_FILES["file"]["tmp_name"]);
  ...
  // Check if the uploaded file is a valid image type by both extension and MIME type
  if (!in_array($imageFileType, $allowedTypes) || !in_array($fileMimeType, ["image/jpeg", "image/png", "image/gif"])) {
