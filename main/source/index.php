          ...
          <div class="aa-header-top-area"> 
            ...
            <div class="aa-header-top-right">
              <ul class="aa-head-top-nav-right">
                <li><a href="http://localhost:30074/">Profile</a></li>
                <li class="hidden-xs"><a href="http://localhost:30073/">Explore</a></li>
      ...
      <ul class="seq-canvas">
        ...
        <li>
          ...
          <div class="seq-title"> <span data-seq>Save Up to 75% Off</span>
            ...
            <a data-seq href="http://localhost:5000/" class="aa-shop-now-btn aa-secondary-btn">GET COUPONS</a> </div>
        </li>
            ...
            <div class="aa-product-inner"> 
              ...
              <div class="tab-content"> 
                ...
                <div class="tab-pane fade in active" id="men">
                  ...
                  <a class="aa-browse-btn" href="http://localhost:30069/">Call US <span class="fa fa-long-arrow-right"></span></a> </div>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="aa-subscribe-area">
          ...
          <form action="http://localhost:30072/" class="aa-subscribe-form">
